...
public class Board implements Map {
    ...
    public Board(String nomBoard, int numberOfCase){
        ...
        if(nomBoard.equals("Easy")){
            makeCaseEasy();
        }else if (nomBoard.equals("Medium") ){
            makeCaseMedium();
        }else if (nomBoard.equals("Hard")){
            makeCaseHard();
        }
        }
        ...
        public void makeCaseEasy(){
            ...
            for ( int j = 0; j < 64; j++) {
                if (j ==37 || j == 40 ||j == 45 || j == 47 || j == 52 || j == 56 || j == 62) {
                    ...
                    Cases carre = new WeaponCase( " Un arc !",  1);
                    boardLength.add(carre);
                } else if (j == 5 || j == 22 || j == 38){
                    Cases carre = new WeaponCase( " Une massue !",  3);
                    boardLength.add(carre);
                } else if (j == 42 || j == 53){
                    Cases carre = new WeaponCase( " Une épée !",  5);
                    boardLength.add(carre);
                } else if (j == 1 || j == 4 || j == 8 || j == 17 || j == 23){
                    Cases carre = new WeaponCase( " Un sort éclair !", 2);
                    boardLength.add(carre);
                } else if (j == 48 || j == 49){
                    Cases carre = new WeaponCase( " Un sort boule de feu !",  7);
                    boardLength.add(carre);
                    ////CASE BONUS/////
